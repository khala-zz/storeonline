...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <?php echo $__env->make('admin.content-header',['name' => 'User','key' => 'Sửa','link' => 'user.index',
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Nhập tên " value="<?php echo e($user -> name); ?>">
...
unset($__errorArgs, $__bag); ?> " placeholder="Nhập email" value="<?php echo e($user -> email); ?>">
...
unset($__errorArgs, $__bag); ?>" style="width: 100%" multiple="multiple" data-placeholder="Choose">
                                        ...
                                        <option 
                                        <?php echo e($roleOfUser -> contains('id',$role -> id) ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div >
                                        <input type="radio"  name="status"  value = 0 <?php echo e($user -> status == 0?'checked':''); ?>>
                                        <label  >Ẩn</label>
                                    </div>
                                    <div >
                                        <input type="radio"  name="status"  value = 1 <?php echo e($user -> status == 1?'checked':''); ?>>
                                        <label >Hiện</label>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\storeOnline\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>