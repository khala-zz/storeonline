...
<?php $__env->startSection('content'); ?>
	<div class="container-fluid">
		<?php echo $__env->make('admin.content-header',['name' => 'Roles','key' => 'Sửa','link' => 'role.index',
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Nhập tên vai trò" value="<?php echo e($role -> name); ?>">
...
unset($__errorArgs, $__bag); ?>" name="display_name" placeholder="Nhập tên hiển thị" value="<?php echo e($role -> display_name); ?>">
										...
										<div class="card mb-3 col-md-12" >
											...
											<div class="row">
												...
												<div class="card-body col-md-3">
													<h5 class="card-title">
														<label >
															<input type="checkbox" name="permission_id[]" value="<?php echo e($permissionsChildrenItem -> id); ?>" class="checkbox_children checkbox_children_<?php echo e($permissionParentItem -> name); ?>" <?php echo e($permissionsChecked->contains('id',$permissionsChildrenItem -> id) ? 'checked':''); ?>>
														</label> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\storeOnline\resources\views/admin/role/edit.blade.php ENDPATH**/ ?>