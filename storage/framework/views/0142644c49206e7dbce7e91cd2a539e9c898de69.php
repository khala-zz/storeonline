...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <?php echo $__env->make('admin.content-header',['name' => 'Coupon','key' => 'Sửa','link' => 'product.index',
                ...
                <div class="card card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <form action="<?php echo e(route('coupon.update',['id' => $coupon -> id])); ?>" method="post"  >
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="coupon_code" placeholder="Nhập tên Coupon" value="<?php echo e($coupon -> coupon_code); ?>">
...
unset($__errorArgs, $__bag); ?>" name="amount" placeholder="Nhập số % giảm" value="<?php echo e($coupon -> amount); ?>">
...
unset($__errorArgs, $__bag); ?>" name="expiry_date" placeholder="dd/mm/yyyy" value="<?php echo e($coupon -> expiry_date); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div >
                                        <input type="radio"  name="status"  value="0" <?php echo e($coupon -> status == 0?'checked':''); ?>>
                                        <label  >Ẩn</label>
                                    </div>
                                    <div >
                                        <input type="radio"  name="status"  value="1" <?php echo e($coupon -> status == 1?'checked':''); ?>>
                                        <label >Hiện</label>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\storeOnline\resources\views/admin/coupon/edit.blade.php ENDPATH**/ ?>