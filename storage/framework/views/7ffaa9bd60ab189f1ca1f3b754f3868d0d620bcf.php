...
<div class="container-fluid">
    ...
    <?php echo $__env->make('admin.content-header',['name' => 'Menu','key' => 'Danh sách','link' => 'menu.create',
        ...
        <div class="col-12">
            <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <?php $__currentLoopData = $parent_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent_menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo e($parent_menu->name); ?>

                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </td>
                                    <td><?php echo e($menu -> created_at -> diffForHumans()); ?></td>
                                    <td><span class="label <?php echo e($menu -> status ==1?'label-success':'label-inverse'); ?>"><?php echo e($menu -> status ==1?'Hiện':'Ẩn'); ?> </span> </td>
                                    
                                    <td>
                                        <a href="<?php echo e(route('menu.edit',['id' => $menu -> id])); ?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                                        <a href="" data-url="<?php echo e(route('menu.delete',['id' => $menu -> id])); ?>" data-toggle="tooltip" data-original-title="Delete" class="sa-warning"> <i class="fa fa-close text-danger"></i> </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 ">
                        <a href="<?php echo e(route('menu.create')); ?>"  class="btn btn-info btn-rounded" >Thêm Menu</a>
                   </div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\storeOnline\resources\views/admin/menu/index.blade.php ENDPATH**/ ?>