...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <?php echo $__env->make('admin.content-header',['name' => 'Brand','key' => 'Sửa','link' => 'brand.index',
                ...
                <div class="card card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <form action="<?php echo e(route('brand.update',['id' => $brand -> id])); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <label> Tên brand</label>
                                    <input type="text" value ="<?php echo e($brand -> name); ?>" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <a href="<?php echo e(route('brand.index')); ?>" class="btn waves-effect waves-light btn-secondary">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\storeOnline\resources\views/admin/brand/edit.blade.php ENDPATH**/ ?>