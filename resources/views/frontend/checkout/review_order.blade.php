    ...
    <div class="container">
        ...
        <div class="row">
            <form action="{{ route('order.submit') }}" method="post" class="form-horizontal">
                ...
                <input type="hidden" name="user_id" value="{{$shipping_address->users_id}}">
                <input type="hidden" name="user_email" value="{{$shipping_address->users_email}}">
                                ...
                                @foreach($cart_datas as $cart_data)
                                    ...
                                    <td class="cart_product">
                                        @foreach($image_products as $image_product)
                                            <a href=""><img src="{{url('products/small',$image_product->feature_image_path)}}" alt="" style="width: 100px;"></a>
                                        @endforeach
                                    </td>
