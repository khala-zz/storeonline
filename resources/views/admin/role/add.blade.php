...
@section('content')
	<div class="container-fluid">
		@include('admin.content-header',['name' => 'Roles','key' => 'Thêm','link' => 'role.index',
						...
						<div class="col-sm-6 col-xs-6">
							...
							<form action="{{ route('role.store') }}" method="post">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control @error('display_name') is-invalid @enderror" name="display_name" placeholder="Nhập tên hiển thị" value="{{ old('display_name') }}">
									@error('display_name')
										...
										<div class="card mb-3 col-md-12" >
											...
											<div class="row">
												...
												<div class="card-body col-md-3">
													<h5 class="card-title">
														<label >
															<input type="checkbox" name="permission_id[]" value="{{$permissionsChildrenItem -> id }}" class="checkbox_children checkbox_children_{{$permissionParentItem -> name}}">
														</label> 
