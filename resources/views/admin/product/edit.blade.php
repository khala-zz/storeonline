...
@section('content')
    <div class="container-fluid">
        @include('admin.content-header',['name' => 'Sản phẩm','key' => 'Sửa','link' => 'product.index',
                        ...
                        <div class="col-sm-6 col-xs-6">
                            <form action="{{ route('product.update',['id' => $product -> id])}}" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ma_sp') is-invalid @enderror" name="ma_sp" placeholder="Nhập mã Sản phẩm" value="{{ $product -> ma_sp }}">
                                    @error('ma_sp')
                                        <div class="alert alert-danger khala-alert">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Nhập tên Sản phẩm" value="{{ $product -> price }}">
                                    @error('price')
                                        <div class="alert alert-danger khala-alert">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-4">
                                    <div class="row">
                                      <img src="{{ $product -> feature_image_path }}" class="image_slider">
                                    </div>
                                  </div>
